...
## Типизация
Как обычно бывает с этим проектом, не укладываюсь в дедлайн, поэтому отправляю на суд то что есть. Сейчас добавила типы только к серверной части, клиентскую сделала не до конца, сейчас я в самом начале пути. На клиенте начала добавлять типы к экшенам редакса, взаимодействующим со стором (чтобы использовать типы с бэкенда).
...
Самое сложное на данный момент — повторно использовать типы, а не добавлять снова примитивные типы для одних и тех же данных.
