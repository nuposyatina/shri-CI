...
## Типизация
Как обычно бывает с этим проектом, не укладываюсь в дедлайн, поэтому отправляю на суд то что есть. Сейчас добавила типы только к серверной части, клиентскую сделала не до конца. На клиенте добавила типы в сторе, перевела на TS почти все компоненты.
