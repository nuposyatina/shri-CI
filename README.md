...
## Типизация
Как обычно бывает с этим проектом, не укладываюсь в дедлайн, поэтому отправляю на суд то что есть. Сейчас добавила типы только к серверной части, клиентскую сделала не до конца, сейчас я в самом начале пути. На клиенте добавила типы в сторе, компоненты еще не трогала.
...
Нашла ошибку в редьюсере очереди билдов благодаря типам.
