...
export default class BuildCard extends Component {
  render() {
    return (
      <div className={`BuildCard BuildCard_status_${this.props.status}`}>
        <div className='BuildCard__Content'>
          <div className='BuildCard__Info'>
            <div className='BuildCard__Main'>
              <svg className='BuildCard__Status BuildCard__Status_status_success' width='16' height='16' viewBox='0 0 16 16' preserveAspectRatio='none' xmlns='http://www.w3.org/2000/svg'>
    ...
    <div className='BuildCard__Number BuildCard__Number_status_success Text Text_size_l Text_view_success'>#{ this.props.buildData.buildNumber }</div>
              <p className='BuildCard__Description Text Text_size_m Text_view_primary'>{ this.props.buildData.commitMessage }</p>
            </div>
            <div className='BuildCard__Git'>
              <div className='BuildCard__CommitInfo'>
                <svg className='BuildCard__Icon' width='16' height='8' viewBox='0 0 16 8' xmlns='http://www.w3.org/2000/svg'>
                ...
                <div className='BuildCard__Branch Text Text_size_s Text_view_primary'>{ this.props.buildData.branchName }</div>
                <div className='BuildCard__Commit Text Text_size_s Text_view_primary'>{ this.props.buildData.commitHash.slice(0, 7) }</div>
              </div>
              <div className='BuildCard__UserInfo'>
                <svg className='BuildCard__Icon' width='13' height='14' viewBox='0 0 13 14' xmlns='http://www.w3.org/2000/svg'>
                ...
                <div className='BuildCard__Author Text Text_size_s Text_view_primary'>{ this.props.buildData.authorName }</div>
              </div>
            </div>
          </div>
          <div className='BuildCard__BuildDateTime'>
            <div className='BuildCard__DateInfo'>
              <svg className='BuildCard__Icon' width='14' height='16' viewBox='0 0 14 16' xmlns='http://www.w3.org/2000/svg'>
              ...
              <time className='BuildCard__Date Text Text_size_s Text_view_primary' dateTime='2020-01-21 03:06'>21 янв, 03:06</time>
            </div>
            <div className='BuildCard__TimeInfo'>
              ...
              <span className='BuildCard__Time Text Text_size_s Text_view_primary'>1 ч 20 мин</span>
            </div>
          </div>
        </div>
      </div>
