        ...
        >
          <div className='Header__Action'>
            ...
            >
              ...
              <span className='Button__Text'>{ localize('Header_BuildButton') }</span>
            </button>
            <Link
            ...
            >
              ...
              <span className='Button__Text'>{ localize('Header_SettingsButton') }</span>
            </Link>
          </div>
        </Header>
        <Layout>
          <section className='Layout__Container BuildHistory'>
            ...
            { !buildsQueue.allBuildsLoaded && (
              ...
              >{ localize('BuildsHistory_LoadButton') }</button>
            ) }
          </section>
        </Layout>
        <Footer />
