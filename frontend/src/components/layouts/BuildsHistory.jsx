      ...
      <Fragment>
        ...
        >
          <div className='Header__Action'>
            ...
            >
              <svg className='Button__Icon Button__Icon_view_primary' width="9" height="10" viewBox="0 0 9 10" xmlns="http://www.w3.org/2000/svg">
        ...
        <Layout>
          <section className='Layout__Container BuildHistory'>
            ...
            />
            { !this.props.buildsQueue.allBuildsLoaded && <button onClick={ this.onShowMoreBuilds } className='Button Button_view_default Button_size_s Button_type_default'>Show more</button>}
          </section>
        </Layout>
        <Footer />
      </Fragment>
